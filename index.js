        ...
        if (command === "gen") {
            if (generated.has(message.author.id)) {
                message.channel.send(
                    "You have a Cool Down of 1 Hour! - " +
                ...
                const embed = {
                    ...
                    footer: {
                        icon_url:
                            "https://cdn.discordapp.com/attachments/795361889169309706/796795501173407744/trav.jpg",
                        text: "🌴GlitchyBrick🌴#6969"
                    },
                    thumbnail: {
                        url:
                            "https://cdn.discordapp.com/attachments/795361889169309706/796795501173407744/trav.jpg"
                    ...
                    if (!err) {
                        ...
                        const embed = {
                            ...
                            footer: {
                                icon_url:
                                    "https://cdn.discordapp.com/attachments/795361889169309706/796795501173407744/trav.jpg",
                                text: "Developed by 🌴GlitchyBrick🌴#6969"
                            },
                            thumbnail: {
                                url:
                                    "https://cdn.discordapp.com/attachments/795361889169309706/796795501173407744/trav.jpg"
...
bot.on("message", message => {
        ...
        var command = message.content
            ...
            if (command === "help") {
                ...
                const embed = {
                    color: 0xff033d,
                    title: 'HakzZz Gen Bot',
                    url: 'https://discord.gg/kgRt8KyKKK',
                    author: {
                        name: 'Command list',
                    ...
                    thumbnail: {
                        url: 'https://cdn.discordapp.com/attachments/795361889169309706/796795501173407744/trav.jpg',
                    },
                    fields: [
                        {
                    ...
                    footer: {
                        text: 'Developed by 🌴GlitchyBrick🌴#6969',
                        icon_url: 'https://cdn.discordapp.com/attachments/795361889169309706/796795501173407744/trav.jpg',
                    },
                };
                message.channel.send({ embed });
            }
        ...
        if (command === "create") {
            ...
            let args = messageArray.slice(1);
            const filePath = __dirname + "/" + args[0] + ".txt";
            fs.writeFile(filePath, 'Glitchy:Glitchy', function (err) {
                if (err) throw err;
                const embed = {
